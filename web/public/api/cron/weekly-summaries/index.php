<?php
/** /api/cron/weekly-summaries?token=... */
require_once __DIR__ . '/../../../../../backend/php/shared/CronJobs.php';
header('Content-Type: application/json; charset=utf-8');
try { cron_validate_token(); echo json_encode(cron_weekly_summaries_job('cron', null), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); }

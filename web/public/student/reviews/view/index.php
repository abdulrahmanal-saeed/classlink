...
if($_SERVER['REQUEST_METHOD']==='POST'){try{learning_submit_review($id,(int)$user['id'],$_POST);header('Location: /student/reviews/result?id='.$id);exit;}catch(Throwable $e){$error=$e->getMessage();}}

 ...
 * Student notifications. Own data only.
 */
...
$notifications = student_portal_notifications((int) $user['id'], 200);

ob_start();
?>
<p class="text-muted">Your learning notifications and updates.</p>
